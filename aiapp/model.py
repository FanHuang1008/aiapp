...
class InferModel():
    ...
    def inference(self, image: Image.Image, topk: int = 5) -> List[Tuple[str, float]]:
        """
        ...
        result = [(label_to_name(idx), f"{prob:.4f}") for idx, prob in zip(topk_class_indices, topk_probabilities)]
        return result
